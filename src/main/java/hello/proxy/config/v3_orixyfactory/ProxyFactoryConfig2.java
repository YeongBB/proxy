package hello.proxy.config.v3_orixyfactory;

import hello.proxy.app.v1.*;
import hello.proxy.app.v2.OrderControllerV2;
import hello.proxy.app.v2.OrderRepositoryV2;
import hello.proxy.app.v2.OrderServiceV2;
import hello.proxy.config.v3_orixyfactory.advice.LogTraceAdvice;
...
public class ProxyFactoryConfig2 {
    ...
    public OrderServiceV2 orderService(LogTrace logTrace){
        OrderServiceV2 orderServiceV1 = new OrderServiceV2(orderRepository(logTrace));
